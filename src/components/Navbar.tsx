        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <Link to="/" aria-label="Home" className="flex items-center">
              ...
              <svg className="h-16 w-auto" viewBox="0 0 1796 1004">
                <g transform="translate(0.000000,1004.000000) scale(0.100000,-0.100000)"
                  // Dynamically set fill based on theme
                  fill={theme === 'dark' ? '#FFFFFF' : '#002B5B'} // White in dark, Blue in light
                  stroke="none">
                    {/* --- Add your validated <path> elements back here --- */}
                    {/* Example path: */}
